...
open class RouteOptions: DirectionsOptions {
     ...
     */
    open var includesAlternativeRoutes = true
    ...
    override open var urlQueryItems: [URLQueryItem] {
        var params: [URLQueryItem] = [
            ...
            URLQueryItem(name: "origin_format", value: String(true)),
            URLQueryItem(name: "steps", value: String(true)),
            URLQueryItem(name: "vehicle", value: profileIdentifier.rawValue)
        ]
        if let coordinates = self.coordinates {
            ...
            if let origin = separated.first {
                ...
                let destination = coordinates.replacingOccurrences(of: origin + ";", with: "")
